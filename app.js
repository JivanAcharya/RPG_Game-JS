...
const locations =[
    ...
    {
        name:"store",
        "button text":["Buy 10 helath (10 gold)","Buy weapon (30 gold)","Go to town square"],
...
function buyHealth(){
    if(gold>= 10){
        ...
        text.innerText ="You do not have enought gold to buy health";
    }
}
function buyWeapon(){
...
function sellWeapon(){
    if (inventory.length >1){
        ...
        text.innerText += "You current inventory is : " + inventory
    }    
    else{
...
function attack(){
    ...
    if((Math.random) <=0.1 && inventory !== 1){
